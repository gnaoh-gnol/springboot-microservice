<h1 align="center"> springboot-microservice </h1> <br>

<p align="center">
  This is a sample microservice project.
  This project contain list of service below:
    - Api Gateway
    ...
    - Product service
  Technologys:
    - Springboot, Spring Security, Spring JPA, Spring Cloud, MySQL, MongoDB
</p>
